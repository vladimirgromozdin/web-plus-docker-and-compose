...
let WishesController = class WishesController {
    ...
    create(createWishDto) {
        return this.wishesService.createWish(createWishDto);
    }
    findOne(id) {
        return this.wishesService.getWishByIdWithOwnerOffersAndWishlists(+id);
    }
    async updateWishInfo(req, id, updateWishDto) {
        const userId = req.user.id;
        let wish;
        try {
            wish = await this.wishesService.getWishByIdWithOwnerOffersAndWishlists(+id);
        }
        catch (error) {
            throw new common_1.InternalServerErrorException(error.message);
        }
        if (!wish || wish.owner.id !== userId) {
            throw new common_1.UnauthorizedException('You can only edit your own wishes');
        }
...
], WishesController.prototype, "getRecentWishes", null);
__decorate([
    (0, common_1.Get)('/top'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], WishesController.prototype, "getMostPopularWishes", null);
__decorate([
...
], WishesController.prototype, "updateWishInfo", null);
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtGuard),
